...
public class PaintingGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        artDesc = new javax.swing.JLabel();
        ...
        artDesc.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        artDesc.setForeground(new java.awt.Color(255, 255, 255));
        artDesc.setText("Media:");
        getContentPane().add(artDesc, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 270, 160, -1));
        ...
        getContentPane().add(artYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 160, -1));
        ...
        getContentPane().add(artName, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 160, -1));
    ...
    private void scanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scanButtonActionPerformed
        try{
           ...
           artName.setText("Name: " + painting.getName(imagerec.getIndex()));
           artYear.setText("Year: " + painting.getYear(imagerec.getIndex()));
           artDesc.setText("Media: " + painting.getDesc(imagerec.getIndex()));
        }
        catch(IOException e){
        }
    ...
    private void findArtworkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findArtworkActionPerformed
        ...
        // IF ARTWORK IS FOUND IN ARRAY
            ...
            artName.setText("Name: " + painting.getName(painting.getArt()));
            artYear.setText("Year: " + painting.getYear(painting.getArt()));
            artDesc.setText("Media: " + painting.getDesc(painting.getArt()));
    ...
    private javax.swing.JLabel artDesc;
