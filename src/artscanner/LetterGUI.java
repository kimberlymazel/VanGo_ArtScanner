...
public class LetterGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        letterNum.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        letterNum.setForeground(new java.awt.Color(255, 255, 255));
        letterNum.setText("Letter No:");
        getContentPane().add(letterNum, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 290, 240, -1));
        ...
        artYear.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        artYear.setForeground(new java.awt.Color(255, 255, 255));
        artYear.setText("Year:");
        getContentPane().add(artYear, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 230, -1));

        artName.setFont(new java.awt.Font("Helvetica Neue", 1, 14)); // NOI18N
        artName.setForeground(new java.awt.Color(255, 255, 255));
        artName.setText("Name:");
        getContentPane().add(artName, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 240, -1));
    ...
    private void scanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_scanButtonActionPerformed
        try{
            ...
            artName.setText("Name: " + letter.getName(imagerec.getIndex()));
            artYear.setText("Year: " + letter.getYear(imagerec.getIndex()));
            recLabel.setText("Receiver: " + letter.getDesc(imagerec.getIndex()));
            letterNum.setText("Letter No: " + letter.getNum(imagerec.getIndex()));
        }
        catch(IOException e){
        }
    ...
    private void findLetterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findLetterActionPerformed
        ...
        // IF LETTER FOUND IN ARRAYLIST
            ...
            artName.setText("Name: " + letter.getName(letter.getArt()));
            artYear.setText("Year: " + letter.getYear(letter.getArt()));
            recLabel.setText("Receiver: " + letter.getDesc(letter.getArt()));
            letterNum.setText("Letter No: " + letter.getNum(letter.getArt()));
    ...
    public void ResetInfo(){
        artSimilarity.setText("Similarity: ");
        artName.setText("Name: ");
        recField.setText("Receiver: ");
        artYear.setText("Year: ");
        numField.setText("Letter No: ");
    ...
    private javax.swing.JLabel artYear;
    ...
    private javax.swing.JLabel letterNum;
